...
class Purchase:
    def __init__(self, id=None, purchase_id='', vendor_id=None, brand_name='', model_name='', quantity=1, purchase_date=None, unit_price=0, total_amount=0, attachment='', created_at=None, customer_id=None, user_id=None, purchase_type='Retail', subtotal=0, total=0, status='Approved', customer_name='', phone_number='', email='', product_type='Retail', sale_type='Retail', invoice='', updated_at=None):
        self.id = id
        self.purchase_id = purchase_id
        self.vendor_id = vendor_id
        ...
        # New Purchase Track fields
        self.customer_name = customer_name or ''
        self.phone_number = phone_number or ''
        self.email = email or ''
        self.product_type = product_type or purchase_type or 'Retail'
        self.sale_type = sale_type or purchase_type or 'Retail'
        ...
        self.purchase_type = purchase_type or self.sale_type
    ...
    def price(self, value):
        self.unit_price = float(value or 0)
    ...
    def total_price(self, value):
        self.total_amount = float(value or 0)
    ...
    def from_dict(cls, data, storage=None):
        purchase = cls(
            ...
            email=data.get('email', ''),
            product_type=data.get('product_type', data.get('purchase_type', 'Retail')),
            sale_type=data.get('sale_type', data.get('purchase_type', 'Retail')),
...
class Offer:
    ...
    def start_date(self, val):
        self._start_date = _parse_date(val) if val else None
    ...
    def end_date(self, val):
        self._end_date = _parse_date(val) if val else None
    ...
    def to_dict(self):
        s_date = self.start_date.isoformat() if (self.start_date and hasattr(self.start_date, 'isoformat')) else (str(self.start_date) if self.start_date else None)
        e_date = self.end_date.isoformat() if (self.end_date and hasattr(self.end_date, 'isoformat')) else (str(self.end_date) if self.end_date else None)
        return {
            'id': self.id,
            'title': self.title,
...
class WhatsAppMessage:
    def __init__(self, id=None, phone_number='', message='', status='Sent', sent_at=None, error=''):
        self.id = id
        self.phone_number = phone_number
        self.message = message
        self.status = status
        self.sent_at = _parse_datetime(sent_at) if sent_at else datetime.utcnow()
        self.error = error
